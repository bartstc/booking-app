...
import { getEnterprise, getEnterpriseKey } from 'modules/enterprise/infrastructure/query';
...
const EditEnterpriseForm = () => {
  ...
  const { data } = useSuspense(getEnterpriseKey(enterpriseId), () => getEnterprise(enterpriseId));

      ...
      availabilities: [
        {
          ...
          priority: 0,
          startTime: dayjs().add(1).hour(9).minute(0).toDate().toString(),
          endTime: dayjs().add(1).hour(17).minute(0).toDate().toString(),
        },
        {
          creationDate: dayjs().toDate().toString(),
          creatorId: '1',
          employeeId: '8e4569eb-e8b9-4072-ab14-e16b4fc1fe6a',
          priority: 0,
          startTime: dayjs().add(2).hour(9).minute(0).toDate().toString(),
          endTime: dayjs().add(2).hour(10).minute(0).toDate().toString(),
        },
        {
          creationDate: dayjs().toDate().toString(),
          creatorId: '1',
          employeeId: '8e4569eb-e8b9-4072-ab14-e16b4fc1fe6a',
          priority: 0,
          startTime: dayjs().add(2).hour(11).minute(0).toDate().toString(),
          endTime: dayjs().add(2).hour(18).minute(0).toDate().toString(),
        },
        {
          creationDate: dayjs().toDate().toString(),
          creatorId: '1',
          employeeId: '8e4569eb-e8b9-4072-ab14-e16b4fc1fe6a',
          priority: 0,
          startTime: dayjs().add(3).hour(9).minute(0).toDate().toString(),
          endTime: dayjs().add(3).hour(10).minute(0).toDate().toString(),
        },
        {
          creationDate: dayjs().toDate().toString(),
          creatorId: '1',
          employeeId: '8e4569eb-e8b9-4072-ab14-e16b4fc1fe6a',
          priority: 0,
          startTime: dayjs().add(4).hour(9).minute(0).toDate().toString(),
          endTime: dayjs().add(4).hour(10).minute(0).toDate().toString(),
        },
        {
          creationDate: dayjs().toDate().toString(),
          creatorId: '1',

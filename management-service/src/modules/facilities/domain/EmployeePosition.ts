...
export class EmployeePosition extends ValueObject<IProps> {
  ...
  public static create(props: IProps): Result<EmployeePosition> {
    ...
    return Result.ok(new EmployeePosition(props));
  }
}

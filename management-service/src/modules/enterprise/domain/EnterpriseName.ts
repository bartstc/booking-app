...
export class EnterpriseName extends ValueObject<IProps> {
  ...
  public static create(props: IProps): Result<EnterpriseName> {
    ...
    return Result.ok(new EnterpriseName(props));
  }
}

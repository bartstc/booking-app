...
{
    public class BookingRecordCanceled
    {
        public BookingRecordCanceled(Guid customerId, Offer offer, Facility facility, Employee employee, DateTime date, short duration, string caution, Guid bookedRecordId)
        {

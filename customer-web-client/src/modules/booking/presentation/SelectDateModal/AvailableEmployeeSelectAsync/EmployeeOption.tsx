...
interface EmployeeOptionProps
  extends OptionProps<AvailableEmployeeOption, false> {}
...
const EmployeeOption = memo(
  (props: EmployeeOptionProps) => {
    ...
    const laterAvailableDate = props.data.isAvailable
      ? undefined
      : bookingTerm?.unavailableEmployees.find(
          (unavailableEmployee) => unavailableEmployee.employeeId === data.value
        )?.laterAvailableDate;
    ...
    return (
      <components.Option {...props}>
        ...
        >
          ...
          <div>
            <Tag
              colorScheme={props.data.isAvailable ? "green" : "red"}
              size="sm"
            >
